// Context API : React 컴포넌트 트리 전체에서 데이터를 공유할 수 있는 방법 제공
// 부모 자식관계가 중첩된 구조에서 데이터를 전달하는 데에 있어
// 불필요한 props drilling(상태 내리꽂기)를 방지
...
const Exam6 = () => {
  ...
  // Context.Provider : 하위 컴포넌트에게 데이터를 전달(제공)할 때 사용
  return (
